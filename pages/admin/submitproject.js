...
export default function SubmitProject({dark,setDark,isMobileOpen,setIsMobileOpen}) {
  ...
  const handlePage2Click = async(e)=>{
    ...
    /* if(uploadRes.data.success){
      await requestCheckout(uploadRes.data.data,uploadRes.data.finalPrice === undefined ? 0 : uploadRes.data.finalPrice)
    } */
  }
                  ...
                  <div className="form-group">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        <input  onChange={(e)=>setProjectName(e.target.value)} value={projectName} placeholder="Project Name"  />
                      </div>
  
                      {/* Collection Count */}
                      <div className="col-md-6">
                        <input  pattern="[0-9]+" type="number" onChange={(e)=>setCollectionCount(e.target.value.replace(/^0+/, ''))} value={collectionCount} placeholder="Collection Count" />
                      </div>
                      ...
                      {/* DESCRIPTION*/}
                      <div className="col-12">
                        <textarea  style={{marginBottom:0}} value={description} maxLength={300} onChange={(e)=>setDescription(e.target.value)} placeholder="Description"></textarea>
