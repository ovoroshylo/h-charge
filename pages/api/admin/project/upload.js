...
handler.post(async(req, res) =>{
    ...
    if(collectionCount=="") collectionCount="123"
    if(blockchainType=="" || blockchainType=="undefined") blockchainType="eth"
    if(saleStatusType==""||saleStatusType=="undefined") saleStatusType="minting"
    if(description=="") description="default"
    if(hasPresale=="") hasPresale="0"
    if(socialInformation.email=="") socialInformation.email="defaul@default.com"
    if(publicsale.price=="") publicsale.price="0"
